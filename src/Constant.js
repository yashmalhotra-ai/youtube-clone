...
export const YOUTUBE_SEARCH_API = `&key=${GOOGLE_API1}`

export const YOUTUBE_VIDEO_API = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=50&regionCode=IN&key=${GOOGLE_API1}`
...
export const RANDOM_VIDEO_API = `https://www.googleapis.com/youtube/v3/search?key=${GOOGLE_API1}&part=snippet&type=video&order=date&maxResults=`
